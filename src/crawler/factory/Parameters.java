...
public class Parameters {
	...
	public static void setNewCollegeScore(HttpRequestBase request) {
		request.setHeader("Accept","text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8");
		request.setHeader("Accept-Encoding","gzip, deflate");
		request.setHeader("Accept-Language","zh-CN,zh;q=0.8,en-US;q=0.5,en;q=0.3");
		request.setHeader("Connection","keep-alive");
		request.setHeader("Cookie", "scrolls=0; JSESSIONID=47F747D3102309F4A99387CC2DF794E3; sto-id-20480-web_80=CBAKBAKMJABP");
		request.setHeader("Host","www.chinadegrees.cn");
		request.setHeader("Referer", "http://www.chinadegrees.cn/webrms/pages/Ranking/xkpmGXZJ.jsp?xkdm=08");
		request.setHeader("User-Agent","Mozilla/5.0 (X11; Linux x86_64; rv:38.0) Gecko/20100101 Firefox/38.0");
	}
